...
The `public contributions` and `private contributions` by users in Spain on `2024/9/16 3:26 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
