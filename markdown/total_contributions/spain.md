...
The `public contributions` and `private contributions` by users in Spain on `2025/4/28 8:28 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
