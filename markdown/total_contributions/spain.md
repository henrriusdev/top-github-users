...
The `public contributions` and `private contributions` by users in Spain on `2024/12/16 6:25 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
