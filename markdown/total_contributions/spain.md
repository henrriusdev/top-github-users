...
The `public contributions` and `private contributions` by users in Spain on `2023/9/4 3:15 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
