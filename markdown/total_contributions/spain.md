...
The `public contributions` and `private contributions` by users in Spain on `2024/2/12 9:15 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
