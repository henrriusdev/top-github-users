...
The `public contributions` and `private contributions` by users in Colombia on `2025/1/6 12:25 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
