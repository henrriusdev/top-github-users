...
The `public contributions` and `private contributions` by users in Colombia on `2024/10/29 12:53 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
