...
The `public contributions` and `private contributions` by users in Colombia on `2024/9/2 9:15 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
