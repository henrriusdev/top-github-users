...
The `public contributions` and `private contributions` by users in Colombia on `2023/5/22 12:19 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
