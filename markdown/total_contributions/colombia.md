...
The `public contributions` and `private contributions` by users in Colombia on `2023/11/14 9:15 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
