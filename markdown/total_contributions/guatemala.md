...
The `public contributions` and `private contributions` by users in Guatemala on `2023/4/24 9:12 PM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.
