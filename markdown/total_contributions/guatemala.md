...
The `public contributions` and `private contributions` by users in Guatemala on `2023/6/5 9:11 PM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.
