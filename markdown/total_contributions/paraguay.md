...
The `public contributions` and `private contributions` by users in Paraguay on `2024/12/31 3:15 PM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.
