...
The `public contributions` and `private contributions` by users in Paraguay on `2023/5/23 12:19 PM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.
