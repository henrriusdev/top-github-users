...
The `public contributions` and `private contributions` by users in Paraguay on `2023/4/11 9:14 AM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.
