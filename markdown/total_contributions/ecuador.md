...
The `public contributions` and `private contributions` by users in Ecuador on `2024/12/30 9:15 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
