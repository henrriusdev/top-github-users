...
The `public contributions` and `private contributions` by users in Ecuador on `2024/6/18 9:16 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
