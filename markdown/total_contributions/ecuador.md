...
The `public contributions` and `private contributions` by users in Ecuador on `2023/9/26 3:14 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
