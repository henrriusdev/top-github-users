...
The `public contributions` and `private contributions` by users in Ecuador on `2023/12/5 3:15 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
