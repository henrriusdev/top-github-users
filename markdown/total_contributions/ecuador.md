...
The `public contributions` and `private contributions` by users in Ecuador on `2024/9/24 6:21 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
