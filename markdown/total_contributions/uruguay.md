...
The `public contributions` and `private contributions` by users in Uruguay on `2023/4/10 3:00 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
