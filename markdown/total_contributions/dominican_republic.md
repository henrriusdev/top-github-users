...
The `public contributions` and `private contributions` by users in Dominican Republic on `2025/4/29 6:30 PM UTC`. This list contains users from `Dominican Republic` and cities `Santo-domingo` `Puerto-plata` `San-pedro-de-macoris` `Santiago-de-los-caballeros` `Higuey`.
