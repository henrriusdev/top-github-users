...
The `number of followers` of users in El Salvador on `2023/6/12 6:14 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
