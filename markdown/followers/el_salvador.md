...
The `number of followers` of users in El Salvador on `2024/5/21 12:20 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
