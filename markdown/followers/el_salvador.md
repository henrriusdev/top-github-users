...
The `number of followers` of users in El Salvador on `2024/10/8 9:16 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
