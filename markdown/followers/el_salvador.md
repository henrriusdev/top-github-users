...
The `number of followers` of users in El Salvador on `2024/8/20 6:17 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
