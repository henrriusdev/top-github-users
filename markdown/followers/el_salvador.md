...
The `number of followers` of users in El Salvador on `2024/9/10 6:19 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
