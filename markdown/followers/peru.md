...
The `number of followers` of users in Peru on `2024/5/20 6:18 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura` `Perú`.

There are `16 countries` and `193 cities` can be found [here](https://github.com/hbourgeot/top-github-users).

There are `977 users`  in Peru. You need at least `14 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>927</td>
		<td>
			<a href="https://github.com/fabohax">
				<img src="https://avatars.githubusercontent.com/u/25891040?s=72&u=025c7c8d9312a45ac30a820e5f5bc4cdc738ce55&v=4" width="24" alt="Avatar of fabohax"> fabohax
			</a><br/>
			Fabo
		</td>
		<td>No Company</td>
