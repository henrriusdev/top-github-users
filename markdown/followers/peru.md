...
The `number of followers` of users in Peru on `2023/5/23 3:14 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
