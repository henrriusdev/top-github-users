...
The `number of followers` of users in Peru on `2023/6/27 12:21 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

There are `16 countries` and `191 cities` can be found [here](https://github.com/hbourgeot/top-github-users).

There are `977 users`  in Peru. You need at least `5 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>975</td>
		<td>
			<a href="https://github.com/diegoches">
				<img src="https://avatars.githubusercontent.com/u/9386435?s=72&u=1e97d7c393347547d904f16177e7d9cc04cd3549&v=4" width="24" alt="Avatar of diegoches"> diegoches
			</a><br/>
