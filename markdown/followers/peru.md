...
The `number of followers` of users in Peru on `2024/12/23 3:24 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura` `Perú`.

There are `16 countries` and `192 cities` can be found [here](https://github.com/henrriusdev/top-github-users).

There are `972 users`  in Peru. You need at least `17 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/caguerra">
				<img src="https://avatars.githubusercontent.com/u/13904546?s=72&v=4" width="24" alt="Avatar of caguerra"> caguerra
			</a><br/>
			César Guerra
		</td>
		<td>Pucp </td>
