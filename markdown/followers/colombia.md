...
The `number of followers` of users in Colombia on `2025/6/24 3:28 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/DevAlexJs">
				<img src="https://avatars.githubusercontent.com/u/189913226?s=72&u=88992fd9b754834966068ec0352f48ec1f358861&v=4" width="24" alt="Avatar of DevAlexJs"> DevAlexJs
			</a><br/>
			Alex-X
		</td>
		<td>Stellar </td>
