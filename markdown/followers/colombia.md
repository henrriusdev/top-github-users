...
The `number of followers` of users in Colombia on `2024/2/13 3:15 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
