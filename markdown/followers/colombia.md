...
The `number of followers` of users in Colombia on `2025/2/3 6:20 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
