...
The `number of followers` of users in Colombia on `2025/2/24 3:19 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
