...
The `number of followers` of users in Colombia on `2025/3/10 8:19 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
