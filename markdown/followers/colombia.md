...
The `number of followers` of users in Colombia on `2023/4/10 10:05 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
