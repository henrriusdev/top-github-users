...
The `number of followers` of users in Colombia on `2024/10/15 12:51 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
