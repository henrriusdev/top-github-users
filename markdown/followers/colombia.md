...
The `number of followers` of users in Colombia on `2024/11/19 12:53 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
