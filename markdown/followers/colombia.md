...
The `number of followers` of users in Colombia on `2024/12/10 12:58 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
