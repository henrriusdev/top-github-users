...
The `number of followers` of users in Colombia on `2024/8/19 9:15 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
