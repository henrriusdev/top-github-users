...
The `number of followers` of users in Colombia on `2024/7/16 3:19 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
