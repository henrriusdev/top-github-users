...
The `number of followers` of users in Colombia on `2023/5/22 12:19 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
