...
The `number of followers` of users in Colombia on `2023/9/19 9:14 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
