...
The `number of followers` of users in Colombia on `2023/5/15 9:14 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
