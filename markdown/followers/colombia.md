...
The `number of followers` of users in Colombia on `2023/12/26 3:14 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
