...
The `number of followers` of users in Ecuador on `2023/12/26 9:14 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
