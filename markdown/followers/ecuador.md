...
The `number of followers` of users in Ecuador on `2023/7/3 3:14 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
