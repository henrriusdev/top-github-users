...
The `number of followers` of users in Spain on `2023/12/4 3:17 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
