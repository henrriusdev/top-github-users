...
The `number of followers` of users in Spain on `2023/12/18 12:41 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
