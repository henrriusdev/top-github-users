...
The `number of followers` of users in Spain on `2023/11/13 3:16 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

There are `16 countries` and `191 cities` can be found [here](https://github.com/hbourgeot/top-github-users).

There are `968 users`  in Spain. You need at least `89 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/kewitz">
				<img src="https://avatars.githubusercontent.com/u/2119706?s=72&u=d8db6654339438cd56106c90bf2673cd94c98881&v=4" width="24" alt="Avatar of kewitz"> kewitz
			</a><br/>
			Leo Kewitz
		</td>
