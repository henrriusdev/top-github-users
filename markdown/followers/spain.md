...
The `number of followers` of users in Spain on `2023/6/20 3:16 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
