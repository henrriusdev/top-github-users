...
The `public contributions` by users in Colombia on `2023/12/12 9:15 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
