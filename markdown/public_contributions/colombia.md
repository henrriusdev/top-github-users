...
The `public contributions` by users in Colombia on `2023/10/17 9:15 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
