...
The `public contributions` by users in Spain on `2023/10/23 3:16 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
