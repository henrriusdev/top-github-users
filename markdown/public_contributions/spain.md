...
The `public contributions` by users in Spain on `2024/12/28 4:30 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
