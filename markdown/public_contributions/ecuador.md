...
The `public contributions` by users in Ecuador on `2023/4/10 3:12 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
