...
The `public contributions` by users in Ecuador on `2023/6/12 3:14 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
