...
The `public contributions` by users in Ecuador on `2023/5/22 6:15 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
