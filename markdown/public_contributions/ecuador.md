...
The `public contributions` by users in Ecuador on `2023/10/3 3:15 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
