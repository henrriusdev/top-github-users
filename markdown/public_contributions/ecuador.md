...
The `public contributions` by users in Ecuador on `2023/5/1 3:13 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
